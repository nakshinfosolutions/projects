...
<body>
    <div class=" text-center tbg">
    <div class="container">
    <div><img src="<?php echo get_bloginfo('template_directory');?>/img/top.jpg" alt=""></div>
...
<?php if ( has_nav_menu( 'primary' ) || has_nav_menu( 'social' ) ) : ?>
        ...
        <span class="icon-bar"></span>
					...
					<div id="site-header-menu" class="collapse navbar-collapse site-header-menu">
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?php echo get_bloginfo('template_directory');?>/img/slider_img.jpg" alt="...">
